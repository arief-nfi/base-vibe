 ...
 */
webhookRoutes.get('/', authorized('ADMIN', 'master.webhook.view'), async (req, res) => {
  try {
 ...
 *         description: Insufficient permissions
 */
webhookRoutes.post('/', validateData(webhookAddSchema), authorized('ADMIN', 'master.webhook.create'), async (req, res) => {
  try {
    const data = req.body;
 ...
 */
webhookRoutes.get('/:id', authorized('ADMIN', 'master.webhook.view'), async (req, res) => {
  try {
 ...
 *         description: Webhook not found
 */
webhookRoutes.put('/:id', validateData(webhookEditSchema), authorized('ADMIN', 'master.webhook.edit'), async (req, res) => {
  try {
    const data = req.body;
 ...
 *         description: Webhook not found
 */
webhookRoutes.delete('/:id', authorized('ADMIN', 'master.webhook.delete'), async (req, res) => {
  try {
 ...
 *         description: Insufficient permissions
 */
webhookRoutes.post('/test-event', authorized('ADMIN', 'master.webhook.view'), async (req, res) => {
  try {
